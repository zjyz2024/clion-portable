...
func init() {
	...
	// Init app
	if app, err = portapps.New("clion-portable", "CLion"); err != nil {
...
func main() {
	ideaExe := "clion64.exe"
	ideaVmOptionsFile := "clion64.exe.vmoptions"
...
idea.log.path={{ DATA_PATH }}/log`, "{{ DATA_PATH }}", utl.FormatUnixPath(app.DataPath), -1)
	...
	// https://www.jetbrains.com/help/clion/tuning-the-ide.html#configure-platform-properties
	os.Setenv("CLION_PROPERTIES", ideaPropPath)

	// https://www.jetbrains.com/help/clion/tuning-the-ide.html#configure-jvm-options
	os.Setenv("CLION_VM_OPTIONS", utl.PathJoin(app.DataPath, vmOptionsFile))
